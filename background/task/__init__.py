...
from .conditional_actions.echo_bag_lock import conditional_actions as echo_bag_lock_conditional_actions
...
synthesis_task.conditionalActions = synthesis_conditional_actions

echo_bag_lock_task = Task()
echo_bag_lock_task.pages = echo_bag_lock_pages  # 声骸背包页面
echo_bag_lock_task.conditionalActions = echo_bag_lock_conditional_actions
